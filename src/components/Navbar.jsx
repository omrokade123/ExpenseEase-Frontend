...
const Navbar = ({ isAuthenticated, setIsAuthenticated }) => {
  ...
  return (
    <div
      className="bg-blue-100 h-10 flex flex-row justify-between items-center"
      style={{ padding: "2rem" }}
    >
      ...
      {isAuthenticated && (
        <div className="flex flex-row justify-between items-center">
          ...
          <button
            type="button"
            onClick={logout}
            className="border-2 bg-red-500 text-white rounded-xl hover:bg-red-700"
            style={{ marginRight: "20px", padding: "5px 12px" }}
          >
            Logout
          </button>
        </div>
